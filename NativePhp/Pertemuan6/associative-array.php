...
// 0 => [arraynya];
echo $perusahaan["pt.1"]["Nama-pt"];
echo $perusahaan["pt.2"]["gaji"];
// echo = $perusahaan[3];//eror karena indexnya bukan numerik lagi
?>
<!doctype html>
<html lang="en">
...
<body class="container">
    ...
    <div class="row m-4 p-4 shadow-sm">
        ...
        <div class="col-10">
            ...
            <button type="button" class="btn btn-link row mt-4">Lihat detail>></button>
        </div>
    </div>
    <?php endforeach;?>

...
<body class="container">
    ...
    <div class="row m-4 p-4 shadow-sm">
        ...
        <div class="col-10">
            ...
            <a href = "./detailperusahaan.php?perusahaan=<?= $lamaran["Nama-pt"]?>&butuh=<?= $lamaran["dibutuhkan"]?>&syarat=<?= $lamaran["syarat"]?>" class="btn btn-link row mt-4">Lihat detail>></a>
        </div>
    </div>
    <?php endforeach;?>

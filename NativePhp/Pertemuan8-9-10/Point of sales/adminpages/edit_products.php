            ...
            <div class="main-panel">
                ...
                <input type="text" name="kode_product" class="form-control" id="namaproduk" required value="<?= $produk["kode_product"];?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="foto_product" class="form-control" id="foto" required
                                    value="<?= $produk["foto_product"];?>">
                            </div>
                            <div class="mb-3">
                                <label for="desk" class="form-label">Deskripsi produk</label>
                                <textarea class="form-control" id="desk" name="deskripsi_product"
                                    rows="10"><?= $produk["deskripsi_product"];?></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="desk" class="form-label">Kategori produk</label>
                                <select class="form-control" name="kategori_product">
                                    ...
                                    <option value="<?= $kategori_opsi['kategori'];?>"><?= $kategori_opsi["kategori"];?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                            <!-- <div class="mb-3">
                ...
                <input class="form-control" type="number" name="stock" id="stok" required value="<?= $produk["stock"];?>">
                            ...
                            <div class="mt-5 d-grid gap-2">
                                <button type="submit" value="edit" name="ubah_product"
                                    class="btn shadow btn-outline-info btn-block">Edit Product</button>
                            </div>

...
$products = queries("SELECT * FROM product ORDER BY id_product DESC");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
            ...
            <table class="table table-bordered text-white table-striped">
                ...
                foreach ($products as $product) : ?>
                    <tr>
                      ...
                      <td style="width: 15em;">
                        <a href="./edit_stocks.php?id_product=<?= $product["id_product"]; ?>" class="btn ml-2 mt-2 btn-warning btn-sm"><i class="mdi mdi-lead-pencil pl-1"></i>
                      </a>
